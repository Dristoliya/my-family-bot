...
# ==================== НАСТРОЙКИ КЛЮЧЕЙ ====================
# Твой токен от @BotFather (остается неизменным)
TELEGRAM_TOKEN = "8965787272:AAEH0lZwfL-QBmwzqzIMx8MBEu6Z-U8u_4w"
# ==========================================================

# Оставляем пустые скобки — клиент САМ автоматически возьмет ключ 
# из созданной вами на Render переменной GEMINI_API_KEY
